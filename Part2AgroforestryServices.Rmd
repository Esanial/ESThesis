...
biom<-read.csv2("C:/Users/Elsa/Documents/Recherche/These/Datanalysis/ESThesis/data220218.csv")
str(biom)
Arbres<-as.data.frame(unique(biom$nom_arb))
library(dplyr)

nomarb<-read.csv2("C:/Users/Elsa/Documents/Recherche/These/Datanalysis/ESThesis/nomarbtot220218.csv")
...
##Timber species##
#ouverture des fichiers avec prise en compte des valeurs manquantes#
...
g<-ggplot(Tabesp3,aes(mT,Freq,color=timber,label=nom_sc))+
...
g4<-ggplot(Tabesp4,aes(timber,Freq,color=timber,label=nom_sc))+
scale_color_manual(values=c("gray3","red4"))+
